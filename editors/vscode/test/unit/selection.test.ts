...
test("the roster holds the thirty-four commands this extension contributes", () => {
	...
	// needs nothing of, and dinah-517 put three filing commands where one
	// stood.
	assert.equal(TREE_COMMANDS.length, 34);
});
