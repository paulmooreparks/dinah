...
func TestAWorkbenchDeclaringEachRevisionOpensOrIsRefused(t *testing.T) {
	opens := []string{"dinah-core/0.1", "dinah-core/0.2", "dinah-core/0.3", "dinah-core/0.4", "dinah-core/1.0"}
	refuses := []string{"dinah-core/0.0", "dinah-core/0.5", "dinah-core/1.1", "dinah-core/2.0", "dinah-core/3.0", "dinah-core/4.0", "dinah-core/9.9"}
...
func TestTheUnsupportedVersionRefusalNamesTheWindow(t *testing.T) {
	...
	got := runCLI(t, root, "status")
	wanted := "; this build reads dinah-core 0.1 through dinah-core 0.4"
