...
var resolvers = []Resolver{
	...
	{File: "entity.go", Function: "resolveWorkstreamRef", Returns: 10, Accepting: 2,
		Forms: []AddressForm{WorkstreamPrefixedSlug, WorkstreamPrefixedIdentifier},
		Why:   "answers a workstream reference carrying the workstream prefix, and walks the grammar below one"},
	{File: "resolve.go", Function: "resolveCardIn", Returns: 10, Accepting: 2,
	...
	{File: "resolve.go", Function: "resolvePathBody", Returns: 6, Accepting: 3,
		Why: "answers the file a resolved reference names"},
	{File: "resolve.go", Function: "resolveReferenceBody", Returns: 14, Accepting: 4,
	...
	{File: "resolve.go", Function: "collectionAt", Returns: 3, Accepting: 1,
	...
	{File: "resolve.go", Function: "resolveBelowLanding", Returns: 7, Accepting: 2,
	...
	{File: "resolve.go", Function: "descend", Returns: 9, Accepting: 4,
	...
	{File: "resolve.go", Function: "ResolveLinkTarget", Returns: 7, Accepting: 3,
	...
	{File: "resolve.go", Function: "ArchivedColumnByRef", Returns: 6, Accepting: 3,
		Forms: []AddressForm{ColumnIdentifier, ColumnSlug, ColumnTitle},
		Why:   "answers an archived column by identifier, then by slug, then by title"},
	{File: "resolve.go", Function: "workstreamByRefIn", Returns: 6, Accepting: 3,
	...
	{File: "workstream.go", Function: "WorkstreamByRef", Returns: 5, Accepting: 2,
		Forms: []AddressForm{WorkstreamPrefixedSlug, WorkstreamPrefixedIdentifier, WorkstreamBareSlug, WorkstreamBareIdentifier},
...
var exemptions = []Exemption{
	...
	{Function: "AddStandingItem", Ground: GroundCreates, Reason: "mints a checklist item from a column's standing entry it is about to copy onto the card"},
	...
	{Function: "PendingStandingInstances", Ground: GroundLists, Reason: "answers every pending checklist item a standing declaration minted for one column"},
	{Function: "StandingInstancesOwedAWithdrawal", Ground: GroundLists, Reason: "answers every checklist item a standing declaration minted for one column that a reshape retiring it still owes a withdrawal or its journal lines"},
