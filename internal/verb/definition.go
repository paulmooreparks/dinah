...
var params = map[string][]Param{
	...
	// the queue, and the resolution reads the provider and the model the
	...
	// and --expires sets the claim's lease exactly as it does on claim. A
	// pull declares nothing about what the caller is, on claim's own terms:
	// the resolution reads the provider and the model against the workbench's
	// table, and it picks the card out of the queue as well as passing the
	// gate the claiming half already ran it through.
	Pull: {
		{Name: "column", Vocabulary: "column", AlsoFlag: true, Field: "Column"},
