...
// when the request declares a harness, filled once here rather than at each
// raise site. It reads req.Harness alone, which the CLI resolves independently
// of whether the actor did.
func harnessExtra(req *Request) map[string]string {
