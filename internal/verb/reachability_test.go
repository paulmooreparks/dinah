...
var declaredPinnedCallSites = []PinnedCallSite{
	...
	{File: "internal/mcp/tools.go", Line: 411, Reason: "the MCP surface is deliberately pinned to English; dinah-245"},
	{File: "internal/mcp/tools.go", Line: 596, Reason: "the MCP surface is deliberately pinned to English; dinah-245"},
...
// language.
var scanDirs = []string{"../../cmd/dinah", "../../internal/mcp", "../../internal/verb", "../../internal/answer", "../../internal/httphead"}
