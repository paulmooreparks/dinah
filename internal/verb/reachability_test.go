...
var declaredPinnedCallSites = []PinnedCallSite{
	{File: "internal/mcp/mcp.go", Line: 167, Reason: "the MCP surface is deliberately pinned to English; dinah-245"},
	{File: "internal/mcp/tools.go", Line: 165, Reason: "the MCP surface is deliberately pinned to English; dinah-245"},
	{File: "internal/mcp/tools.go", Line: 201, Reason: "the MCP surface is deliberately pinned to English; dinah-245"},
}
