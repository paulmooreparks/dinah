...
var declaredPinnedCallSites = []PinnedCallSite{
	...
	{File: "internal/mcp/tools.go", Line: 273, Reason: "the MCP surface is deliberately pinned to English; dinah-245"},
	{File: "internal/mcp/tools.go", Line: 437, Reason: "the MCP surface is deliberately pinned to English; dinah-245"},
}
