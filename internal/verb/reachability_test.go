...
var declaredPinnedCallSites = []PinnedCallSite{
	...
	{File: "internal/mcp/tools.go", Line: 376, Reason: "the MCP surface is deliberately pinned to English; dinah-245"},
	{File: "internal/mcp/tools.go", Line: 561, Reason: "the MCP surface is deliberately pinned to English; dinah-245"},
}
