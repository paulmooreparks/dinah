...
const (
	...
	declaredVersion = "This document is version 0.15 of the profile whose identity string is\n`dinah-core`."
	// publishedStatements is how many statements the document publishes.
	publishedStatements = 140
	...
	// here.
	declaredCurrentRevision = "The current revision is `dinah-core 0.15`."
)
