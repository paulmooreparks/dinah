...
const (
	...
	declaredVersion = "This document is version 0.13 of the profile whose identity string is\n`dinah-core`."
	// publishedStatements is how many statements the document publishes.
	publishedStatements = 138
	...
	// here.
	declaredCurrentRevision = "The current revision is `dinah-core 0.13`."
)
