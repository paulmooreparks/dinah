...
const (
	...
	declaredVersion = "This document is version 0.16 of the profile whose identity string is\n`dinah-core`."
	// publishedStatements is how many statements the document publishes.
	publishedStatements = 153
	...
	// here.
	declaredCurrentRevision = "The current revision is `dinah-core 0.16`."
)
