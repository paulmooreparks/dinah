...
const (
	...
	declaredVersion = "This document is version 0.12 of the profile whose identity string is\n`dinah-core`."
	// publishedStatements is how many statements the document publishes.
	publishedStatements = 137
	...
	// here.
	declaredCurrentRevision = "The current revision is `dinah-core 0.12`."
)
