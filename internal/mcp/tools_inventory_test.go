...
var publishedProperties = map[string][]string{
	...
	"waive_item":        {"actor", "designation", "harness", "item", "model", "provider", "server", "text", "workbench"},
	"withdraw_item":     {"actor", "designation", "harness", "item", "model", "provider", "server", "text", "workbench"},
	"reopen_item":       {"actor", "harness", "item", "model", "provider", "reason", "server", "workbench"},
	"grant":             {"actor", "card", "harness", "model", "permission", "provider", "server", "workbench"},
	"revoke":            {"actor", "card", "harness", "model", "permission", "provider", "server", "workbench"},
	...
	"view":              {"actor", "card", "explain", "harness", "model", "provider", "server", "view", "workbench"},
...
var basisProbeArguments = map[string]map[string]any{
	...
	"unblock":          {"card": "fx-1", "reason": "a probe"},
