...
func TestAssignMarkerCoversEveryPublishedMarker(t *testing.T) {
	...
	if len(names) != 28 {
		t.Fatalf("swept %d markers, wanted 28 (twenty-four already wired, plus migrate-designations, rehearse and force-claims from dinah-472, plus file-standing from dinah-593)", len(names))
	}
