Setup has written the project-scope configuration for Claude Code under <BASE>. Close any Claude Code session that is open before you run setup, because Claude Code writes some of these files itself when you change a setting. Four things remain, and they are yours to do.
